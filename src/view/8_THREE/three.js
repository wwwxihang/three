...
window.UA = function(e) {
		...
		return t.indexOf("Android") > -1 ? e.platform = "android" : /iPhone|iPad|iPod/.test(t) ? e.platform = "ios" : /Windows Phone|WPDesktop/.test(t) ? e.platform = "winphone" : e.platform = "pc", e[e.platform] = !0, e.qqVersion = function() {
			...
			try {
				for (var i = 0, r = Math.max(e.length, t.length); r > i; i++) {
					var n = isFinite(e[i]) && Number(e[i]) || 0,
						o = isFinite(t[i]) && Number(t[i]) || 0;
					if (o > n) return -1;
					if (n > o) return 1
				}
			} catch (a) {
		...
		function c(e, t, i, r) {
			if (ne.acceptData(e)) {
				var n, o, a = ne.expando,
					s = e.nodeType,
					l = s ? ne.cache : e,
					h = s ? e[a] : e[a] && a;
				if (h && l[h] && (r || l[h].data) || void 0 !== i || "string" != typeof t) return h || (h = s ? e[a] = Y.pop() || ne.guid++ : a), l[h] || (l[h] = s ? {} : {
					toJSON: ne.noop
				}), ("object" == typeof t || "function" == typeof t) && (r ? l[h] = ne.extend(l[h], t) : l[h].data = ne.extend(l[h].data, t)), o = l[h], r || (o.data || (o.data = {}), o = o.data), void 0 !== i && (o[ne.camelCase(t)] = i), "string" == typeof t ? (n = o[t], null == n && (n = o[ne.camelCase(t)])) : n = o, n
			}
		}
		...
		function E(e, t) {
			...
			if (!o)
				for (o = [], i = e.childNodes || e; null != (r = i[n]); n++) !t || ne.nodeName(r, t) ? o.push(r) : ne.merge(o, E(r, t));
		...
		function R(e, t) {
			if (1 === t.nodeType && ne.hasData(e)) {
				var i, r, n, o = ne._data(e),
					a = ne._data(t, o),
					s = o.events;
				if (s) {
					delete a.handle, a.events = {};
					for (i in s)
						for (r = 0, n = s[i].length; n > r; r++) ne.event.add(t, i, s[i][r])
				}
		...
		function S(e, t) {
			if (t in e) return t;
			for (var i = t.charAt(0).toUpperCase() + t.slice(1), r = t, n = pt.length; n--;)
		...
		function k(e, t, i) {
			for (var r, n = (yt[t] || []).concat(yt["*"]), o = 0, a = n.length; a > o; o++)
				if (r = n[o].call(i, t, e)) return r
		}

		function N(e, t, i) {
			var r, n, o, a, s, l, h, c, u = this,
				p = {},
				d = e.style,
				f = e.nodeType && Me(e),
				m = ne._data(e, "fxshow");
			...
			if (ne.isEmptyObject(p)) "inline" === ("none" === h ? w(e.nodeName) : h) && (d.display = h);
			else {
		...
		function U(e, t) {
			var i, r, n, o, a;
			for (i in e)
				if (r = ne.camelCase(i), n = t[r], o = e[i], ne.isArray(o) && (n = o[1], o = e[i] = o[0]), i !== r && (e[r] = o, delete e[i]), a = ne.cssHooks[r], a && "expand" in a) {
		...
		function z(e, t, i) {
			...
			for (U(c, h.opts.specialEasing); a > o; o++)
				if (r = vt[o].call(h, e, c, h.opts)) return r;
		...
		function j(e, t, i, r) {
			...
			for (o = c.shift(); o;)
				if (e.responseFields[o] && (i[e.responseFields[o]] = t), !l && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)), l = o, o = c.shift())
					if ("*" === o) o = l;
					else if ("*" !== l && l !== o) {
				if (a = h[l + " " + o] || h["* " + o], !a)
					for (n in h)
		...
		ne.fn = ne.prototype = {
			...
			var e, t, i, r, n, o, a = arguments[0] || {},
				...
				l = arguments.length,
				h = !1;
			for ("boolean" == typeof a && (h = a, a = arguments[s] || {}, s++), "object" == typeof a || ne.isFunction(a) || (a = {}), s === l && (a = this, s--); l > s; s++)
				if (null != (n = arguments[s]))
					for (r in n) e = a[r], i = n[r], a !== i && (h && i && (ne.isPlainObject(i) || (t = ne.isArray(i))) ? (t ? (t = !1, o = e && ne.isArray(e) ? e : []) : o = e && ne.isPlainObject(e) ? e : {}, a[r] = ne.extend(h, o, i)) : void 0 !== i && (a[r] = i));
			return a
		}, ne.extend({
		...
		var he = function(e) {
			...
			function g(e, t, i, n, o, a) {
				return n && !n[O] && (n = g(n)), o && !o[O] && (o = g(o, a)), r(function(r, a, s, l) {
					var h, c, u, p = [],
						...
						v = !e || !r && t ? g : E(g, p, e, s, l),
						y = i ? o || (r ? e : f || n) ? [] : a : v;
					if (i && i(v, y, s, l), n)
						for (h = E(y, d), n(h, [], s, l), c = h.length; c--;)(u = h[c]) && (y[d[c]] = !(v[d[c]] = u));
					if (r) {
						if (o || e) {
							if (o) {
			...
			function v(e) {
				for (var t, i, r, n = e.length, o = R.relative[e[0].type], a = o || R.relative[" "], s = o ? 1 : 0, l = d(function(e) {
					...
					if (i = R.relative[e[s].type]) c = [d(f(c), i)];
					else {
						if (i = R.filter[e[s].type].apply(null, e[s].matches), i[O]) {
							...
							return g(s > 1 && f(c), s > 1 && p(e.slice(0, s - 1).concat({
								value: " " === e[s - 2].type ? "*" : ""
							})).replace(le, "$1"), i, r > s && v(e.slice(s, r)), n > r && v(e = e.slice(r)), n > r && p(e))
						}
						c.push(i)
					}
				return f(c)
			...
			var T, x, R, b, H, w, _, S, M, C, A, L, D, P, F, k, N, U, z, O = "sizzle" + -new Date,
				B = e.document,
				V = 0,
				I = 0,
				j = i(),
			...
			x = t.support = {}, H = t.isXML = function(e) {
				...
				var i = R.attrHandle[t.toLowerCase()],
					r = i && K.call(R.attrHandle, t.toLowerCase()) ? i(e, t, !F) : void 0;
				...
				filter: {
					...
					CHILD: function(e, t, i, r, n) {
						...
						return 1 === r && 0 === n ? function(e) {
							...
							var h, c, u, p, d, f, m = o !== a ? "nextSibling" : "previousSibling",
								E = t.parentNode,
							...
							if (E) {
								...
								if (f = [a ? E.firstChild : E.lastChild], a && v) {
									for (c = E[O] || (E[O] = {}), h = c[e] || [], d = h[0] === V && h[1], p = h[0] === V && h[2], u = d && E.childNodes[d]; u = ++d && u && u[m] || (p = d = 0) || f.pop();)
										if (1 === u.nodeType && ++p && u === t) {
											c[e] = [V, d, p];
											break
										}
								} else if (v && (h = (t[O] || (t[O] = {}))[e]) && h[0] === V) p = h[1];
								else
									for (;
										(u = ++d && u && u[m] || (p = d = 0) || f.pop()) && ((s ? u.nodeName.toLowerCase() !== g : 1 !== u.nodeType) || !++p || (v && ((u[O] || (u[O] = {}))[e] = [V, p]), u !== t)););
				...
				pseudos: {
					...
					lang: r(function(e) {
						return de.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(xe, Re).toLowerCase(),
							function(t) {
								var i;
								do
									if (i = F ? t.lang : t.getAttribute("xml:lang") || t.getAttribute("lang")) return i = i.toLowerCase(), i === e || 0 === i.indexOf(e + "-");
			...
			return u.prototype = R.filters = R.pseudos, R.setFilters = new u, w = t.tokenize = function(e, i) {
				...
				if (i = i || [], 1 === u.length) {
					...
					for (n = fe.needsContext.test(e) ? 0 : o.length; n-- && (a = o[n], !R.relative[s = a.type]);)
						if ((l = R.find[s]) && (r = l(a.matches[0].replace(xe, Re), ye.test(o[0].type) && c(t.parentNode) || t))) {
		...
		var de, fe = e.document,
			...
			Ee = ne.fn.init = function(e, t) {
				...
				if ("string" == typeof e) {
					...
					if (i[1]) {
						if (t = t instanceof ne ? t[0] : t, ne.merge(this, ne.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : fe, !0)), ue.test(i[1]) && ne.isPlainObject(t))
		...
		ne.extend({
			...
			closest: function(e, t) {
				for (var i, r = 0, n = this.length, o = [], a = ce.test(e) || "string" != typeof e ? ne(e, t || this.context) : 0; n > r; r++)
		...
		ne.Callbacks = function(e) {
				...
				u = {
					...
					remove: function() {
						return l && ne.each(arguments, function(e, i) {
							for (var r;
								(r = ne.inArray(i, l, r)) > -1;) l.splice(r, 1), t && (n >= r && n--, a >= r && a--)
						}), this
					},
					has: function(e) {
			...
			when: function(e) {
				...
				if (a > 1)
					for (t = new Array(a), i = new Array(a), r = new Array(a); a > n; n++) o[n] && ne.isFunction(o[n].promise) ? o[n].promise().done(h(n, r, o)).fail(l.reject).progress(h(n, i, t)) : --s;
		...
		ne.fn.ready = function(e) {
			...
			if (!xe)
				if (xe = ne.Deferred(), "complete" === fe.readyState) setTimeout(ne.ready);
		...
		ne.event = {
			...
			remove: function(e, t, i, r, n) {
				...
				if (E && (c = E.events)) {
					for (t = (t || "").match(ye) || [""], h = t.length; h--;)
						if (s = ke.exec(t[h]) || [], d = m = s[1], f = (s[2] || "").split(".").sort(), d) {
			...
			trigger: function(t, i, r, n) {
				...
				if (s = c = r = r || fe, 3 !== r.nodeType && 8 !== r.nodeType && !Fe.test(d + ne.event.triggered) && (d.indexOf(".") >= 0 && (f = d.split("."), d = f.shift(), f.sort()), a = d.indexOf(":") < 0 && "on" + d, t = t[ne.expando] ? t : new ne.Event(d, "object" == typeof t && t), t.isTrigger = n ? 2 : 3, t.namespace = f.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), i = null == i ? [t] : ne.makeArray(i, [t]), h = ne.event.special[d] || {}, n || !h.trigger || h.trigger.apply(r, i) !== !1)) {
					...
					for (u = 0;
						(s = p[u++]) && !t.isPropagationStopped();) t.type = u > 1 ? l : h.bindType || d, o = (ne._data(s, "events") || {})[t.type] && ne._data(s, "handle"), o && o.apply(s, i), o = a && s[a], o && o.apply && ne.acceptData(s) && (t.result = o.apply(s, i), t.result === !1 && t.preventDefault());
				...
				if (s[0] = e, e.delegateTarget = this, !h.preDispatch || h.preDispatch.call(this, e) !== !1) {
					for (a = ne.event.handlers.call(this, e, l), t = 0;
						...
						for (e.currentTarget = n.elem, o = 0;
							(r = n.handlers[o++]) && !e.isImmediatePropagationStopped();)(!e.namespace_re || e.namespace_re.test(r.namespace)) && (e.handleObj = r, e.data = r.data, i = ((ne.event.special[r.origType] || {}).handle || r.handler).apply(n.elem, s), void 0 !== i && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
		...
		var Ne = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
			...
			$e = m(fe),
			Qe = $e.appendChild(fe.createElement("div"));
		Ke.optgroup = Ke.option, Ke.tbody = Ke.tfoot = Ke.colgroup = Ke.caption = Ke.thead, Ke.th = Ke.td, ne.extend({
			clone: function(e, t, i) {
				...
				if (ie.html5Clone || ne.isXMLDoc(e) || !ze.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Qe.innerHTML = e.outerHTML, Qe.removeChild(o = Qe.firstChild)), !(ie.noCloneEvent && ie.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ne.isXMLDoc(e)))
					for (r = E(o), s = E(e), a = 0; null != (n = s[a]); ++a) r[a] && b(n, r[a]);
				if (t)
					if (i)
						for (s = s || E(e), r = r || E(o), a = 0; null != (n = s[a]); a++) R(n, r[a]);
					else R(e, o);
				return r = E(o, "script"), r.length > 0 && x(r, !l && E(e, "script")), r = s = n = null, o
			},
			buildFragment: function(e, t, i, r) {
				for (var n, o, a, s, l, h, c, u = e.length, p = m(t), d = [], f = 0; u > f; f++)
					if (o = e[f], o || 0 === o)
					...
					if (!ie.leadingWhitespace && Oe.test(o) && d.push(t.createTextNode(Oe.exec(o)[0])), !ie.tbody)
						for (o = "table" !== l || Ie.test(o) ? "<table>" !== c[1] || Ie.test(o) ? 0 : s : s.firstChild, n = o && o.childNodes.length; n--;) ne.nodeName(h = o.childNodes[n], "tbody") && !h.childNodes.length && o.removeChild(h);
					for (ne.merge(d, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
					s = p.lastChild
				} else d.push(t.createTextNode(o));
				for (s && p.removeChild(s), ie.appendChecked || ne.grep(E(d, "input"), g), f = 0; o = d[f++];)
					if ((!r || -1 === ne.inArray(o, r)) && (a = ne.contains(o.ownerDocument, o), s = E(p.appendChild(o), "script"), a && x(s), i))
						for (n = 0; o = s[n++];) Xe.test(o.type || "") && i.push(o);
				return s = null, p
			},
			cleanData: function(e, t) {
				for (var i, r, n, o, a = 0, s = ne.expando, l = ne.cache, h = ie.deleteExpando, c = ne.event.special; null != (i = e[a]); a++)
					if ((t || ne.acceptData(i)) && (n = i[s], o = n && l[n])) {
						if (o.events)
							for (r in o.events) c[r] ? ne.event.remove(i, r) : ne.removeEvent(i, r, o.handle);
			...
			domManip: function(e, t) {
				...
				if (h && (s = ne.buildFragment(e, this[0].ownerDocument, !1, this), i = s.firstChild, 1 === s.childNodes.length && (s = i), i)) {
					...
					if (n)
						for (a = o[o.length - 1].ownerDocument, ne.map(o, T), l = 0; n > l; l++) r = o[l], Xe.test(r.type || "") && !ne._data(r, "globalEval") && ne.contains(a, r) && (r.src ? ne._evalUrl && ne._evalUrl(r.src) : ne.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Ye, "")));
					s = i = null
				}
				return this
			}
		...
		e.getComputedStyle ? (et = function(e) {
			...
			function t() {
				var t, i, r, n;
				i = fe.getElementsByTagName("body")[0], i && i.style && (t = fe.createElement("div"), r = fe.createElement("div"), r.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", i.appendChild(r).appendChild(t), t.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", o = a = !1, l = !0, e.getComputedStyle && (o = "1%" !== (e.getComputedStyle(t, null) || {}).top, a = "4px" === (e.getComputedStyle(t, null) || {
					width: "4px"
			...
			yt = {
				"*": [function(e, t) {
					var i = this.createTween(e, t),
						r = i.cur(),
						n = Et.exec(t),
						o = n && n[3] || (ne.cssNumber[e] ? "" : "px"),
						a = (ne.cssNumber[e] || "px" !== o && +r) && Et.exec(ne.css(i.elem, e)),
						s = 1,
						l = 20;
					if (a && a[3] !== o) {
						o = o || a[3], n = n || [], a = +r || 1;
				...
				stop: function(e, t, i) {
					...
					return "string" != typeof e && (i = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function() {
						...
						if (n) a[n] && a[n].stop && r(a[n]);
							...
							for (n in a) a[n] && a[n].stop && gt.test(n) && r(a[n]);
				...
				select: {
					get: function(e) {
						for (var t, i, r = e.options, n = e.selectedIndex, o = "select-one" === e.type || 0 > n, a = o ? null : [], s = o ? n + 1 : r.length, l = 0 > n ? s : o ? n : 0; s > l; l++)
							if (i = r[l], !(!i.selected && l !== n || (ie.optDisabled ? i.disabled : null !== i.getAttribute("disabled")) || i.parentNode.disabled && ne.nodeName(i.parentNode, "optgroup"))) {
					...
					set: function(e, t) {
						for (var i, r, n = e.options, o = ne.makeArray(t), a = n.length; a--;)
							if (r = n[a], ne.inArray(ne.valHooks.option.get(r), o) >= 0) try {
								r.selected = i = !0
							} catch (s) {
								r.scrollHeight
							} else r.selected = !1;
		...
		var xt, Rt, bt = ne.expr.attrHandle,
			Ht = /^(?:checked|selected)$/i,
			wt = ie.getSetAttribute,
			_t = ie.input;
		ne.fn.extend({
			attr: function(e, t) {
			...
			removeAttr: function(e, t) {
				var i, r, n = 0,
					o = t && t.match(ye);
				if (o && 1 === e.nodeType)
					for (; i = o[n++];) r = ne.propFix[i] || i, ne.expr.match.bool.test(i) ? _t && wt || !Ht.test(i) ? e[r] = !1 : e[ne.camelCase("default-" + i)] = e[r] = !1 : ne.attr(e, i, ""), e.removeAttribute(wt ? i : r)
			},
			attrHooks: {
				type: {
					set: function(e, t) {
		...
		ne.fn.extend({
			addClass: function(e) {
				...
				if (h)
					for (t = (e || "").match(ye) || []; l > s; s++)
						if (i = this[s], r = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(Ct, " ") : " ")) {
			...
			toggleClass: function(e, t) {
				...
				return "boolean" == typeof t && "string" === i ? t ? this.addClass(e) : this.removeClass(e) : this.each(ne.isFunction(e) ? function(i) {
					...
					if ("string" === i)
						for (var t, r = 0, n = ne(this), o = e.match(ye) || []; t = o[r++];) n.hasClass(t) ? n.removeClass(t) : n.addClass(t);
					else(i === be || "boolean" === i) && (this.className && ne._data(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : ne._data(this, "__className__") || "")
				})
			},
			hasClass: function(e) {
				for (var t = " " + e + " ", i = 0, r = this.length; r > i; i++)
					if (1 === this[i].nodeType && (" " + this[i].className + " ").replace(Ct, " ").indexOf(t) >= 0) return !0;
				return !1
			}
		...
		Pt = Vt.exec(Ft.toLowerCase()) || [], ne.extend({
			...
			ajax: function(e, t) {
				...
				var r, n, o, a, s, l, h, c, u = ne.ajaxSetup({}, t),
					p = u.context || u,
					d = u.context && (p.nodeType || p.jquery) ? ne(p) : ne.event,
					f = ne.Deferred(),
					...
					x = {
						...
						getResponseHeader: function(e) {
							...
							if (2 === y) {
								if (!c)
									for (c = {}; t = Ut.exec(a);) c[t[1].toLowerCase()] = t[2];
								t = c[e.toLowerCase()]
							}
					...
					send: function(i, r) {
						...
						o.send(e.hasContent && e.data || null), t = function(i, n) {
							...
							if (t && (n || 4 === o.readyState))
								if (delete Zt[a], t = void 0, o.onreadystatechange = ne.noop, n) 4 !== o.readyState && o.abort();
								else {
		...
		ne.ajaxSetup({
			...
			var n, o, a, s = t.jsonp !== !1 && (ti.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && ti.test(t.data) && "data");
		...
		ne.offset = {
			setOffset: function(e, t, i) {
				var r, n, o, a, s, l, h, c = ne.css(e, "position"),
					u = ne(e),
					p = {};
		...
		e.fn.fullpage = function(l) {
			...
			function ie() {
				...
				for (var i = 0; i < e(x).length; i++) {
					...
					var n = '<li><a href="#' + r + '"><span></span></a>',
						o = l.navigationTooltips[i];
			...
			function se(i) {
				...
				if (!le(i.target) && he(n)) {
					...
					var o = e(R),
						a = l.scrollOverflowHandler.scrollable(o);
					if (Mt && !xt) {
						var s = at(n);
			...
			function pe(i) {
				...
				if (l.autoScrolling && !Tt) {
					...
					var c = e(R),
						u = l.scrollOverflowHandler.scrollable(c),
						p = n - jt;
					if (jt = n, p > 200 && (Ct = []), Mt) {
						var d = ue(Ct, 10),
							f = ue(Ct, 70),
			...
			function de(t, i) {
				var r = "undefined" == typeof i ? e(R) : i,
					n = r.find(U),
					o = n.find(F).length;
				if (!(!n.length || xt || 2 > o)) {
					var a = n.find(k),
			...
			function me(t, i, r) {
				requestAnimFrame(function() {
					...
					if ("undefined" != typeof n) {
						var o = t.hasClass(S) && n.top ? n.top - wt + t.height() : n.top,
							a = {
								element: t,
								callback: i,
								isMovementUp: r,
			...
			function Ve(e) {
				...
				var t, i = l.scrollOverflowHandler,
					r = i.wrapContent(),
					n = e.closest(x),
					o = i.scrollable(e);
			...
			function Qe(e) {
				...
				else if (Rt || bt) history.replaceState(n, n, "#" + e);
				else {
			...
			var vt, yt, Tt, xt = !1,
				...
				bt = "ontouchstart" in t || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints,
				Ht = e(this),
				wt = ee.height(),
				_t = !1,
				St = !0,
			...
			te.on("click touchstart", C + " a", function(t) {
				...
				t.preventDefault();
				var i = e(this).closest(x).find(U),
					r = i.find(F).eq(e(this).closest("li").index());
				Ae(i, r)
		...
		var a = e.requestAnimationFrame || e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || e.oRequestAnimationFrame || e.msRequestAnimationFrame || function(t) {
			...
			s = function() {
				...
				var n = {},
					...
					a = function() {
						for (var e, t = ["t", "webkitT", "MozT", "msT", "OT"], i = 0, r = t.length; r > i; i++)
		...
		r.prototype = {
			...
			_move: function(e) {
				if (this.enabled && s.eventType[e.type] === this.initiated) {
					...
					var t, r, n, o, a = e.touches ? e.touches[0] : e,
			...
			_end: function(e) {
				if (this.enabled && s.eventType[e.type] === this.initiated) {
					...
					var t, r, n = (e.changedTouches ? e.changedTouches[0] : e, s.getTime() - this.startTime),
						o = i.round(this.x),
						a = i.round(this.y),
			...
			_translate: function(e, t) {
				if (this.options.useTransform ? this.scrollerStyle[s.style.transform] = "translate(" + e + "px," + t + "px)" + this.translateZ : (e = i.round(e), t = i.round(t), this.scrollerStyle.left = e + "px", this.scrollerStyle.top = t + "px"), this.x = e, this.y = t, this.indicators)
			...
			_wheel: function(e) {
				if (this.enabled) {
					...
					if (void 0 === this.wheelTimeout && a._execEvent("scrollStart"), clearTimeout(this.wheelTimeout), this.wheelTimeout = setTimeout(function() {
						...
						}, 400), "deltaX" in e) 1 === e.deltaMode ? (t = -e.deltaX * this.options.mouseWheelSpeed, r = -e.deltaY * this.options.mouseWheelSpeed) : (t = -e.deltaX, r = -e.deltaY);
				...
				this.currentPage = {}, "string" == typeof this.options.snap && (this.options.snap = this.scroller.querySelectorAll(this.options.snap)), this.on("refresh", function() {
					...
					if (this.pages = [], this.wrapperWidth && this.wrapperHeight && this.scrollerWidth && this.scrollerHeight) {
						if (this.options.snap === !0)
							for (r = i.round(c / 2), n = i.round(u / 2); h > -this.scrollerWidth;) {
								...
								for (a = this.options.snap, e = a.length, t = -1; e > s; s++)(0 === s || a[s].offsetLeft <= a[s - 1].offsetLeft) && (l = 0, t++), this.pages[l] || (this.pages[l] = []), h = i.max(-a[s].offsetLeft, this.maxScrollX), o = i.max(-a[s].offsetTop, this.maxScrollY), r = h - i.round(a[s].offsetWidth / 2), n = o - i.round(a[s].offsetHeight / 2), this.pages[l][t] = {
									x: h,
									y: o,
			...
			_nearestSnap: function(e, t) {
				...
				for (e > 0 ? e = 0 : e < this.maxScrollX && (e = this.maxScrollX), t > 0 ? t = 0 : t < this.maxScrollY && (t = this.maxScrollY); n > r; r++)
					if (e >= this.pages[r][0].cx) {
						e = this.pages[r][0].x;
						break
					}
				for (n = this.pages[r].length; n > o; o++)
			...
			_key: function(e) {
				if (this.enabled) {
					var t, r = this.options.snap,
						n = r ? this.currentPage.pageX : this.x,
						o = r ? this.currentPage.pageY : this.y,
						a = s.getTime(),
						l = this.keyTime || 0,
						h = .25;
...
self.console = self.console || {
	...
	function() {
			...
			return function(t) {
				...
				return t.updateMatrixWorld(!0), this.makeEmpty(), t.traverse(function(t) {
					if (void 0 !== t.geometry && void 0 !== t.geometry.vertices)
						for (var r = t.geometry.vertices, n = 0, o = r.length; o > n; n++) e.copy(r[n]), e.applyMatrix4(t.matrixWorld), i.expandByPoint(e)
				}), this
			}
		}(),
		copy: function(e) {
		...
		distanceSqToSegment: function(e, t, i, r) {
			var n = e.clone().add(t).multiplyScalar(.5),
	...
	function(e) {
		...
		var r = new e.Vector3,
			...
			h = function(o, c, u) {
				if (o instanceof e.Sprite) {
				...
				} else if (o instanceof e.LOD) r.setFromMatrixPosition(o.matrixWorld), p = c.ray.origin.distanceTo(r), h(o.getObjectForDistance(p), c, u);
					...
					if (d instanceof e.BufferGeometry) {
						...
						if (void 0 !== g.index) {
							...
							for (var R = 0, b = x.length; b > R; ++R)
								for (var g = x[R].start, H = x[R].index, d = g, w = g + x[R].count; w > d; d += 3) {
							...
							for (T = g.position.array, d = 0, w = g.position.array.length; w > d; d += 3) g = d, m = d + 1, E = d + 2, a.set(T[3 * g], T[3 * g + 1], T[3 * g + 2]), s.set(T[3 * m], T[3 * m + 1], T[3 * m + 2]), l.set(T[3 * E], T[3 * E + 1], T[3 * E + 2]), _ = f.side === e.BackSide ? i.intersectTriangle(l, s, a, !0) : i.intersectTriangle(a, s, l, f.side !== e.DoubleSide), null !== _ && (_.applyMatrix4(o.matrixWorld), p = c.ray.origin.distanceTo(_), v > p || p < c.near || p > c.far || u.push({
								distance: p,
								point: _,
								indices: [g, m, E],
								face: null,
					...
					} else if (d instanceof e.Geometry)
						for (T = o.material instanceof e.MeshFaceMaterial, x = !0 === T ? o.material.materials : null, v = c.precision, y = d.vertices, R = 0, b = d.faces.length; b > R; R++)
							if (H = d.faces[R], f = !0 === T ? x[H.materialIndex] : o.material, void 0 !== f) {
					...
					if (n.getInverse(o.matrixWorld), i.copy(c.ray).applyMatrix4(n), d instanceof e.Geometry)
						for (y = d.vertices, v = y.length, g = new e.Vector3, m = new e.Vector3, E = o.type === e.LineStrip ? 1 : 2, d = 0; v - 1 > d; d += E) i.distanceSqToSegment(y[d], y[d + 1], m, g) > f || (p = i.origin.distanceTo(m), p < c.near || p > c.far || u.push({
							distance: p,
		...
		var I = function(e) {
				if (!1 !== e.visible) {
					if (e instanceof THREE.Light) _.lights.push(e);
					else if ((e instanceof THREE.Mesh || e instanceof THREE.Line || e instanceof THREE.Sprite) && (!1 === e.frustumCulled || !0 === O.intersectsObject(e))) {
						if (a === g) {
				...
				if (y = _.objects[o].object, T = y.geometry, j.setObject(y), m = y.matrixWorld, l = 0, y instanceof THREE.Mesh) {
					if (T instanceof THREE.BufferGeometry) {
						if (A = T.attributes, y = T.offsets, void 0 !== A.position) {
							...
							if (void 0 !== A.normal)
								for (P = A.normal.array, T = 0, R = P.length; R > T; T += 3) j.pushNormal(P[T], P[T + 1], P[T + 2]);
							if (void 0 !== A.uv)
								for (P = A.uv.array, T = 0, R = P.length; R > T; T += 2) j.pushUv(P[T], P[T + 1]);
							if (void 0 !== A.index)
								if (A = A.index.array, 0 < y.length)
									for (o = 0; o < y.length; o++)
										for (R = y[o], D = R.index, T = R.start, R = R.start + R.count; R > T; T += 3) j.pushTriangle(A[T] + D, A[T + 1] + D, A[T + 2] + D);
								else
									for (T = 0, R = A.length; R > T; T += 3) j.pushTriangle(A[T], A[T + 1], A[T + 2]);
							else
								for (T = 0, R = D.length / 3; R > T; T += 3) j.pushTriangle(T, T + 1, T + 2)
						}
						...
						for (F = 0, W = R.length; W > F; F++) {
							...
							if (void 0 !== X) {
								...
								if (!1 !== j.checkTriangleVisibility(G, Y, K)) {
									...
									if (h.vertexNormalsLength = b.length, q = A[F], void 0 !== q)
										for (b = 0; 3 > b; b++) h.uvs[b].copy(q[b]);
		...
		computeVertexNormals: function() {
			if (this.attributes.position) {
				...
				if (this.attributes.index) {
					...
					for (e = 0, t = c.length; t > e; e += 9) s = c[e], l = c[e + 1], h = c[e + 2], p.set(s, l, h), s = c[e + 3], l = c[e + 4], h = c[e + 5], d.set(s, l, h), s = c[e + 6], l = c[e + 7], h = c[e + 8], f.set(s, l, h), m.subVectors(f, d), E.subVectors(p, d), m.cross(E), u[e] = m.x, u[e + 1] = m.y, u[e + 2] = m.z, u[e + 3] = m.x, u[e + 4] = m.y, u[e + 5] = m.z, u[e + 6] = m.x, u[e + 7] = m.y, u[e + 8] = m.z;
		...
		computeTangents: function() {
			...
			if (void 0 === this.attributes.index || void 0 === this.attributes.position || void 0 === this.attributes.normal || void 0 === this.attributes.uv) console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");
				...
				var u, p, d, f, m, E, g, v, y, T, x, R, b, H, w, _, S, M, C, A, L, D, P, F, k, N, U, z, O, B, V, I = new THREE.Vector3,
					j = new THREE.Vector3,
					W = this.offsets,
					c = 0;
				...
				var X, q, Y, K = new THREE.Vector3,
					$ = new THREE.Vector3,
					Q = new THREE.Vector3,
					Z = new THREE.Vector3,
					c = 0;
				for (z = W.length; z > c; ++c)
					for (U = W[c].start, O = W[c].count, G = W[c].index, a = U, U += O; U > a; a += 3) O = G + i[a], B = G + i[a + 1], V = G + i[a + 2], t(O), t(B), t(V)
			}
		},
		...
		reorderBuffers: function(e, t, i) {
			...
			for (r in this.attributes)
				...
				for (o = 0; i > o; o++)
					for (r in a = t[o], this.attributes)
						if ("index" != r)
							for (var s = this.attributes[r].array, l = this.attributes[r].itemSize, h = n[r], c = 0; l > c; c++) h[o * l + c] = s[a * l + c];
		...
		computeTangents: function() {
			var e, t, i, r, n, o, a, s, l, h, c, u, p, d, f, m, E, g = [],
				v = [];
			i = new THREE.Vector3;
			...
			for (y = ["a", "b", "c", "d"], e = 0, t = this.faces.length; t > e; e++)
				for (n = this.faces[e], i = 0; i < Math.min(n.vertexNormals.length, 3); i++) R.copy(n.vertexNormals[i]), r = n[y[i]], E = g[r], T.copy(E), T.sub(R.multiplyScalar(R.dot(E))).normalize(), x.crossVectors(n.vertexNormals[i], E), r = x.dot(v[r]), r = 0 > r ? -1 : 1, n.vertexTangents[i] = new THREE.Vector4(T.x, T.y, T.z, r);
			this.hasTangents = !0
		},
		...
		mergeVertices: function() {
			...
			for (t = r.length - 1; t >= 0; t--)
				for (a = r[t], this.faces.splice(a, 1), o = 0, i = this.faceVertexUvs.length; i > o; o++) this.faceVertexUvs[o].splice(a, 1);
		...
		return function(t) {
				...
				for (a = 0, s = E.length; s > a;)
					if (t = E[a++], u = 1 & t, o = 2 & t, r = 8 & t, h = 16 & t, p = 32 & t, l = 64 & t, t &= 128, u) {
						if (u = new THREE.Face3, u.a = E[a], u.b = E[a + 1], u.c = E[a + 3], d = new THREE.Face3, d.a = E[a + 1], d.b = E[a + 2], d.c = E[a + 3], a += 4, o && (o = E[a++], u.materialIndex = o, d.materialIndex = o), o = i.faces.length, r)
							for (r = 0; y > r; r++)
								for (f = e.uvs[r], i.faceVertexUvs[r][o] = [], i.faceVertexUvs[r][o + 1] = [], n = 0; 4 > n; n++) c = E[a++], m = f[2 * c], c = f[2 * c + 1], m = new THREE.Vector2(m, c), 2 !== n && i.faceVertexUvs[r][o].push(m), 0 !== n && i.faceVertexUvs[r][o + 1].push(m);
						if (h && (h = 3 * E[a++], u.normal.set(g[h++], g[h++], g[h]), d.normal.copy(u.normal)), p)
							for (r = 0; 4 > r; r++) h = 3 * E[a++], p = new THREE.Vector3(g[h++], g[h++], g[h]), 2 !== r && u.vertexNormals.push(p), 0 !== r && d.vertexNormals.push(p);
						if (l && (l = E[a++], l = v[l], u.color.setHex(l), d.color.setHex(l)), t)
							for (r = 0; 4 > r; r++) l = E[a++], l = v[l], 2 !== r && u.vertexColors.push(new THREE.Color(l)), 0 !== r && d.vertexColors.push(new THREE.Color(l));
						i.faces.push(u), i.faces.push(d)
					} else {
						if (u = new THREE.Face3, u.a = E[a++], u.b = E[a++], u.c = E[a++], o && (o = E[a++], u.materialIndex = o), o = i.faces.length, r)
							for (r = 0; y > r; r++)
								for (f = e.uvs[r], i.faceVertexUvs[r][o] = [], n = 0; 3 > n; n++) c = E[a++], m = f[2 * c], c = f[2 * c + 1], m = new THREE.Vector2(m, c), i.faceVertexUvs[r][o].push(m);
						if (h && (h = 3 * E[a++], u.normal.set(g[h++], g[h++], g[h])), p)
							for (r = 0; 3 > r; r++) h = 3 * E[a++], p = new THREE.Vector3(g[h++], g[h++], g[h]), u.vertexNormals.push(p);
						if (l && (l = E[a++], u.color.setHex(v[l])), t)
							for (r = 0; 3 > r; r++) l = E[a++], u.vertexColors.push(new THREE.Color(v[l]));
						i.faces.push(u)
					}
			}(r),
			function() {
		...
		parseMaterials: function(e) {
			var t = {};
			if (void 0 !== e)
				for (var i = new THREE.MaterialLoader, r = 0, n = e.length; n > r; r++) {
					var o = e[r],
						a = i.parse(o);
		...
		parse: function(e, t, i) {
					...
					if (void 0 === u) {
						if (m.type && m.type in H.hierarchyHandlers) {
							...
							if (p = R.geometries[m.geometry]) {
								if (u = !1, d = R.materials[m.material], u = d instanceof THREE.ShaderMaterial, n = m.position, a = m.rotation, s = m.scale, i = m.matrix, h = m.quaternion, m.material || (d = new THREE.MeshFaceMaterial(R.face_materials[m.geometry])), d instanceof THREE.MeshFaceMaterial && 0 === d.materials.length && (d = new THREE.MeshFaceMaterial(R.face_materials[m.geometry])), d instanceof THREE.MeshFaceMaterial)
									for (v = 0; v < d.materials.length; v++) u = u || d.materials[v] instanceof THREE.ShaderMaterial;
						...
						if (u) {
							if (void 0 !== m.userData)
								for (var y in m.userData) u.userData[y] = m.userData[y];
							if (void 0 !== m.groups)
								for (v = 0; v < m.groups.length; v++) i = m.groups[v], void 0 === R.groups[i] && (R.groups[i] = []), R.groups[i].push(c)
						}
					}
			...
			function u(e, t) {
				if (t(e), void 0 !== e.children)
					for (var i in e.children) u(e.children[i], t)
			}
			var p, d, f, m, E, g, v, y, T, x, R, b, H = this,
			...
			for (C in S.geometries)
				if (m = S.geometries[C], "cube" === m.type) p = new THREE.BoxGeometry(m.width, m.height, m.depth, m.widthSegments, m.heightSegments, m.depthSegments), p.name = C, R.geometries[C] = p;
				else if ("plane" === m.type) p = new THREE.PlaneGeometry(m.width, m.height, m.widthSegments, m.heightSegments), p.name = C, R.geometries[C] = p;
			else if ("sphere" === m.type) p = new THREE.SphereGeometry(m.radius, m.widthSegments, m.heightSegments), p.name = C, R.geometries[C] = p;
			else if ("cylinder" === m.type) p = new THREE.CylinderGeometry(m.topRad, m.botRad, m.height, m.radSegs, m.heightSegs), p.name = C, R.geometries[C] = p;
			else if ("torus" === m.type) p = new THREE.TorusGeometry(m.radius, m.tube, m.segmentsR, m.segmentsT), p.name = C, R.geometries[C] = p;
			else if ("icosahedron" === m.type) p = new THREE.IcosahedronGeometry(m.radius, m.subdivisions), p.name = C, R.geometries[C] = p;
			...
			for (var L in S.textures)
				if (C = S.textures[L], C.url instanceof Array)
					for (y += C.url.length, E = 0; E < C.url.length; E++) H.onLoadStart();
				else y += 1, H.onLoadStart();
			x = y;
			for (L in S.textures) {
			...
			for (D in S.materials)
				if (L = S.materials[D], L.parameters.materials) {
		...
		return function(t) {
			...
			if (void 0 == this.boneInverses)
				for (this.boneInverses = [], t = 0, i = this.bones.length; i > t; t++) r = new THREE.Matrix4, r.getInverse(this.bones[t].skinMatrix), this.boneInverses.push(r);
		...
		var t = new THREE.BufferGeometry;
		return t.addAttribute("position", e),
			function(e) {
		...
		function o(e, t, i, o, a, s, l, h, c, u, p, f, m) {
			if (!(m instanceof THREE.DataTexture)) {
				...
				if (void 0 !== E) {
					d(E);
					var E = m.offset.x / m.repeat.x,
						g = m.offset.y / m.repeat.y,
						v = m.image.width * m.repeat.x;
		...
		var K, $, Q, Z, J, ee, te, ie = new THREE.Color,
			re = new THREE.Color,
			ne = new THREE.Color,
			oe = {},
			ae = new THREE.Box2,
		...
		} : function() {}), this.domElement = w, this.devicePixelRatio = void 0 !== e.devicePixelRatio ? e.devicePixelRatio : void 0 !== self.devicePixelRatio ? self.devicePixelRatio : 1, this.sortElements = this.sortObjects = this.autoClear = !0, this.info = {
			render: {
				vertices: 0,
				faces: 0
			}
		...
		}, this.clearColor = function() {}, this.clearDepth = function() {}, this.clearStencil = function() {}, this.render = function(e, w) {
			if (!1 == w instanceof THREE.Camera) console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
			else {
						...
						if (le.makeEmpty(), P instanceof THREE.RenderableSprite) {
							...
							if (le.min.set(L.x - P, L.y - P), le.max.set(L.x + P, L.y + P), D instanceof THREE.SpriteMaterial || D instanceof THREE.ParticleSystemMaterial) {
								...
								if (null !== U) {
									...
									var z = U.image,
										P = z.width * U.offset.x,
										F = z.height * U.offset.y,
										O = z.width * U.repeat.x,
										U = z.height * U.repeat.y,
										z = N / O,
										B = k / U;
							...
							if (T = P.v1, x = P.v2, T.positionScreen.x *= M, T.positionScreen.y *= C, x.positionScreen.x *= M, x.positionScreen.y *= C, le.setFromPoints([T.positionScreen, x.positionScreen]), !0 === ae.isIntersectionBox(le))
								if (L = T, D = x, N = P, k = F, s(k.opacity), l(k.blending), A.beginPath(), A.moveTo(L.positionScreen.x, L.positionScreen.y), A.lineTo(D.positionScreen.x, D.positionScreen.y), k instanceof THREE.LineBasicMaterial) {
									if (h(k.linewidth), c(k.linecap), u(k.linejoin), k.vertexColors !== THREE.VertexColors) p(k.color.getStyle());
									else if (P = N.vertexColors[0].getStyle(), N = N.vertexColors[1].getStyle(), P === N) p(P);
									else {
										try {
		...
		function p(e, t, i) {
			if (e.length)
				for (var r = 0, n = e.length; n > r; r++) ie = Z = null, ee = te = oe = ne = ue = ce = ae = -1, Ce = !0, e[r].render(t, i, Te, xe), ie = Z = null, ee = te = oe = ne = ue = ce = ae = -1, Ce = !0
		}
		...
		function m(e, r) {
			var n, o, a;
			if (void 0 === e.__webglInit && (e.__webglInit = !0, e._modelViewMatrix = new THREE.Matrix4, e._normalMatrix = new THREE.Matrix3, o = e.geometry, void 0 !== o && void 0 === o.__webglInit))
				if (o.__webglInit = !0, o.addEventListener("dispose", je), o instanceof THREE.BufferGeometry)
					for (a in o.attributes) {
						var s = "index" === a ? W.ELEMENT_ARRAY_BUFFER : W.ARRAY_BUFFER,
							l = o.attributes[a];
						l.buffer = W.createBuffer(), W.bindBuffer(s, l.buffer), W.bufferData(s, l.array, W.STATIC_DRAW)
					} else if (e instanceof THREE.Mesh) {
						for (n in a = e.material, void 0 === o.geometryGroups && o.makeGroups(a instanceof THREE.MeshFaceMaterial, K ? 4294967296 : 65535), o.geometryGroups)
							if (a = o.geometryGroups[n], !a.__webglVertexBuffer) {
								...
								if (s.numMorphTargets)
									for (s.__webglMorphTargetsBuffers = [], l = 0, h = s.numMorphTargets; h > l; l++) s.__webglMorphTargetsBuffers.push(W.createBuffer());
								if (s.numMorphNormals)
									for (s.__webglMorphNormalsBuffers = [], l = 0, h = s.numMorphNormals; h > l; l++) s.__webglMorphNormalsBuffers.push(W.createBuffer());
			...
			if (void 0 === e.__webglActive) {
				if (e instanceof THREE.Mesh) {
					if (o = e.geometry, o instanceof THREE.BufferGeometry) E(r.__webglObjects, o, e);
					else if (o instanceof THREE.Geometry)
						for (n in o.geometryGroups) a = o.geometryGroups[n], E(r.__webglObjects, a, e)
		...
		function R(e, t, i, r, n) {
			...
			var o = !1,
				...
				s = a.uniforms,
				l = r.uniforms;
			if (a.id !== Z && (W.useProgram(a.program), Z = a.id, o = !0), r.id !== ee && (ee = r.id, o = !0), (o || e !== ie) && (W.uniformMatrix4fv(s.projectionMatrix, !1, e.projectionMatrix.elements), V && W.uniform1f(s.logDepthBufFC, 2 / (Math.log(e.far + 1) / Math.LN2)), e !== ie && (ie = e)), r.skinning)
				if (Ne && n.useVertexTexture) {
			...
			if (o) {
				if (i && r.fog && (l.fogColor.value = i.color, i instanceof THREE.Fog ? (l.fogNear.value = i.near, l.fogFar.value = i.far) : i instanceof THREE.FogExp2 && (l.fogDensity.value = i.density)), r instanceof THREE.MeshPhongMaterial || r instanceof THREE.MeshLambertMaterial || r.lights) {
					if (Ce) {
						var c, u, p, d, f = h = 0,
							m = 0,
							E = Ae,
							g = E.directional.colors,
							v = E.directional.positions,
							y = E.point.colors,
							T = E.point.positions,
							x = E.point.distances,
							R = E.spot.colors,
				...
				if (r instanceof THREE.LineBasicMaterial ? (l.diffuse.value = r.color, l.opacity.value = r.opacity) : r instanceof THREE.LineDashedMaterial ? (l.diffuse.value = r.color, l.opacity.value = r.opacity, l.dashSize.value = r.dashSize, l.totalSize.value = r.dashSize + r.gapSize, l.scale.value = r.scale) : r instanceof THREE.ParticleSystemMaterial ? (l.psColor.value = r.color, l.opacity.value = r.opacity, l.size.value = r.size, l.scale.value = D.height / 2, l.map.value = r.map) : r instanceof THREE.MeshPhongMaterial ? (l.shininess.value = r.shininess, $.gammaInput ? (l.ambient.value.copyGammaToLinear(r.ambient), l.emissive.value.copyGammaToLinear(r.emissive), l.specular.value.copyGammaToLinear(r.specular)) : (l.ambient.value = r.ambient, l.emissive.value = r.emissive, l.specular.value = r.specular), r.wrapAround && l.wrapRGB.value.copy(r.wrapRGB)) : r instanceof THREE.MeshLambertMaterial ? ($.gammaInput ? (l.ambient.value.copyGammaToLinear(r.ambient), l.emissive.value.copyGammaToLinear(r.emissive)) : (l.ambient.value = r.ambient, l.emissive.value = r.emissive), r.wrapAround && l.wrapRGB.value.copy(r.wrapRGB)) : r instanceof THREE.MeshDepthMaterial ? (l.mNear.value = e.near, l.mFar.value = e.far, l.opacity.value = r.opacity) : r instanceof THREE.MeshNormalMaterial && (l.opacity.value = r.opacity), n.receiveShadow && !r._shadowPass && l.shadowMatrix)
					for (i = Y = 0, o = t.length; o > i; i++) h = t[i], h.castShadow && (h instanceof THREE.SpotLight || h instanceof THREE.DirectionalLight && !h.shadowCascade) && (l.shadowMap.value[Y] = h.shadowMap, l.shadowMapSize.value[Y] = h.shadowMapSize, l.shadowMatrix.value[Y] = h.shadowMatrix, l.shadowDarkness.value[Y] = h.shadowDarkness, l.shadowBias.value[Y] = h.shadowBias, Y++);
				for (t = r.uniformsList, l = 0, Y = t.length; Y > l; l++)
					if (o = a.uniforms[t[l][1]])
						if (i = t[l][0], f = i.type, h = i.value, "i" === f) W.uniform1i(o, h);
						else if ("f" === f) W.uniform1f(o, h);
				else if ("v2" === f) W.uniform2f(o, h.x, h.y);
				else if ("v3" === f) W.uniform3f(o, h.x, h.y, h.z);
				else if ("v4" === f) W.uniform4f(o, h.x, h.y, h.z, h.w);
				else if ("c" === f) W.uniform3f(o, h.r, h.g, h.b);
				else if ("iv1" === f) W.uniform1iv(o, h);
				else if ("iv" === f) W.uniform3iv(o, h);
				else if ("fv1" === f) W.uniform1fv(o, h);
				else if ("fv" === f) W.uniform3fv(o, h);
				else if ("v2v" === f) {
				...
				} else if ("m4" === f) void 0 === i._array && (i._array = new Float32Array(16)), h.flattenToArray(i._array), W.uniformMatrix4fv(o, !1, i._array);
				else if ("m4v" === f) {
						...
						if (E.image instanceof Array && 6 === E.image.length) {
							if (i = E, o = h, 6 === i.image.length)
								if (i.needsUpdate) {
									...
									for (f = h[0], m = THREE.Math.isPowerOfTwo(f.width) && THREE.Math.isPowerOfTwo(f.height), E = L(i.format), g = L(i.type), M(W.TEXTURE_CUBE_MAP, i, m), f = 0; 6 > f; f++)
										if (o)
											for (y = h[f].mipmaps, T = 0, x = y.length; x > T; T++) v = y[T], i.format !== THREE.RGBAFormat ? W.compressedTexImage2D(W.TEXTURE_CUBE_MAP_POSITIVE_X + f, T, E, v.width, v.height, 0, v.data) : W.texImage2D(W.TEXTURE_CUBE_MAP_POSITIVE_X + f, T, E, v.width, v.height, 0, E, g, v.data);
										else W.texImage2D(W.TEXTURE_CUBE_MAP_POSITIVE_X + f, 0, E, E, g, h[f]);
		...
		var W, G, X, q, Y, K, $ = this,
			...
			we = new THREE.Matrix4,
			_e = new THREE.Matrix4,
		...
		var Le = W.getParameter(W.MAX_TEXTURE_IMAGE_UNITS),
			De = W.getParameter(W.MAX_VERTEX_TEXTURE_IMAGE_UNITS);
		W.getParameter(W.MAX_TEXTURE_SIZE);
		var Pe = W.getParameter(W.MAX_CUBE_MAP_TEXTURE_SIZE),
			Fe = q ? W.getParameter(q.MAX_TEXTURE_MAX_ANISOTROPY_EXT) : 0,
			ke = De > 0,
			Ne = ke && G;
		...
		var Ve = 0 < Ue.precision && 0 < Oe.precision,
			Ie = 0 < ze.precision && 0 < Be.precision;
		...
		var je = function(e) {
				if (e = e.target, e.removeEventListener("dispose", je), e.__webglInit = void 0, e instanceof THREE.BufferGeometry) {
					...
					for (i in e.geometryGroups) {
						if (t = e.geometryGroups[i], void 0 !== t.numMorphTargets)
							for (var r = 0, n = t.numMorphTargets; n > r; r++) W.deleteBuffer(t.__webglMorphTargetsBuffers[r]);
						if (void 0 !== t.numMorphNormals)
							for (r = 0, n = t.numMorphNormals; n > r; r++) W.deleteBuffer(t.__webglMorphNormalsBuffers[r]);
						qe(t)
					} else qe(e)
			},
			We = function(e) {
			...
			Ge = function(e) {
				if (e = e.target, e.removeEventListener("dispose", Ge), e && e.__webglTexture)
					if (W.deleteTexture(e.__webglTexture), e instanceof THREE.WebGLRenderTargetCube)
						for (var t = 0; 6 > t; t++) W.deleteFramebuffer(e.__webglFramebuffer[t]), W.deleteRenderbuffer(e.__webglRenderbuffer[t]);
					else W.deleteFramebuffer(e.__webglFramebuffer), W.deleteRenderbuffer(e.__webglRenderbuffer);
		...
		this.renderBufferImmediate = function(e, t, i) {
			...
			if (!1 !== r.visible) {
				var l = R(e, t, i, r, o);
				if (e = l.attributes, t = n.attributes, i = !1, l = 16777215 * n.id + 2 * l.id + (r.wireframe ? 1 : 0), l !== te && (te = l, i = !0), i && s(), o instanceof THREE.Mesh)
					if (o = t.index) {
						var h;
						if (o.array instanceof Uint32Array ? (l = W.UNSIGNED_INT, h = 4) : (l = W.UNSIGNED_SHORT, h = 2), n = n.offsets, 0 === n.length) i && (a(r, e, t, 0), W.bindBuffer(W.ELEMENT_ARRAY_BUFFER, o.buffer)), W.drawElements(W.TRIANGLES, o.array.length, l, 0), $.info.render.calls++, $.info.render.vertices += o.array.length, $.info.render.faces += o.array.length / 3;
						else {
							i = !0;
					...
					} else i && a(r, e, t, 0), r = n.attributes.position, W.drawArrays(W.TRIANGLES, 0, r.array.length / 3), $.info.render.calls++, $.info.render.vertices += r.array.length / 3, $.info.render.faces += r.array.length / 9;
				else if (o instanceof THREE.ParticleSystem) i && a(r, e, t, 0), r = t.position, W.drawArrays(W.POINTS, 0, r.array.length / 3), $.info.render.calls++, $.info.render.points += r.array.length / 3;
				else if (o instanceof THREE.Line)
					if (l = o.type === THREE.LineStrip ? W.LINE_STRIP : W.LINES, _(r.linewidth), o = t.index)
						if (o.array instanceof Uint32Array ? (l = W.UNSIGNED_INT, h = 4) : (l = W.UNSIGNED_SHORT, h = 2), n = n.offsets, 0 === n.length) i && (a(r, e, t, 0), W.bindBuffer(W.ELEMENT_ARRAY_BUFFER, o.buffer)), W.drawElements(W.LINES, o.array.length, l, 0), $.info.render.calls++, $.info.render.vertices += o.array.length;
						else
							for (1 < n.length && (i = !0), c = 0, u = n.length; u > c; c++) p = n[c].index, i && (a(r, e, t, p), W.bindBuffer(W.ELEMENT_ARRAY_BUFFER, o.buffer)), W.drawElements(W.LINES, n[c].count, l, n[c].start * h), $.info.render.calls++, $.info.render.vertices += n[c].count;
				else i && a(r, e, t, 0), r = t.position, W.drawArrays(l, 0, r.array.length / 3), $.info.render.calls++, $.info.render.points += r.array.length / 3
			}
		}, this.renderBuffer = function(e, t, i, r, n, o) {
			if (!1 !== r.visible) {
				var a, c;
				if (i = R(e, t, i, r, o), t = i.attributes, e = !1, i = 16777215 * n.id + 2 * i.id + (r.wireframe ? 1 : 0), i !== te && (te = i, e = !0), e && s(), !r.morphTargets && 0 <= t.position) e && (W.bindBuffer(W.ARRAY_BUFFER, n.__webglVertexBuffer), l(t.position), W.vertexAttribPointer(t.position, 3, W.FLOAT, !1, 0, 0));
				...
				if (e) {
					if (n.__webglCustomAttributesList)
						for (a = 0, c = n.__webglCustomAttributesList.length; c > a; a++) i = n.__webglCustomAttributesList[a], 0 <= t[i.buffer.belongsToAttribute] && (W.bindBuffer(W.ARRAY_BUFFER, i.buffer), l(t[i.buffer.belongsToAttribute]), W.vertexAttribPointer(t[i.buffer.belongsToAttribute], i.size, W.FLOAT, !1, 0, 0));
			...
			if (!1 == t instanceof THREE.Camera) console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
				...
				for (ee = -1, Ce = !0, !0 === e.autoUpdate && e.updateMatrixWorld(), void 0 === t.parent && t.updateMatrixWorld(), t.matrixWorldInverse.getInverse(t.matrixWorld), we.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), He.setFromMatrix(we), this.autoUpdateObjects && this.initWebGLObjects(e), p(this.renderPluginsPre, e, t), $.info.render.calls = 0, $.info.render.vertices = 0, $.info.render.faces = 0, $.info.render.points = 0, this.setRenderTarget(i), (this.autoClear || r) && this.clear(this.autoClearColor, this.autoClearDepth, this.autoClearStencil), s = e.__webglObjects, r = 0, n = s.length; n > r; r++)
					if (o = s[r], a = o.object, o.id = r, o.render = !1, a.visible && (!(a instanceof THREE.Mesh || a instanceof THREE.ParticleSystem) || !a.frustumCulled || He.intersectsObject(a))) {
						var u = a;
			...
			for (var t = 0, a = e.__webglObjects.length; a > t; t++) {
				...
				if (h instanceof THREE.BufferGeometry) {
					...
					for (var R = 0, b = h.geometryGroupsList.length; b > R; R++)
						if (c = h.geometryGroupsList[R], d = r(l, c), h.buffersNeedUpdate && i(c, l), p = d.attributes && g(d), h.verticesNeedUpdate || h.morphTargetsNeedUpdate || h.elementsNeedUpdate || h.uvsNeedUpdate || h.normalsNeedUpdate || h.colorsNeedUpdate || h.tangentsNeedUpdate || p) {
							var H = c,
								w = l,
								_ = W.DYNAMIC_DRAW,
								S = !h.dynamic,
							...
							if (H.__inittedArrays) {
								var C = n(M),
									...
									Be = H.__tangentArray,
									Ve = H.__colorArray,
									Ie = H.__skinIndexArray,
									je = H.__skinWeightArray,
									We = H.__morphTargetsArrays,
									Ge = H.__morphNormalsArrays,
									Xe = H.__webglCustomAttributesList,
									qe = void 0,
									Ye = H.__faceArray,
									Ke = H.__lineArray,
									$e = w.geometry,
									Qe = $e.elementsNeedUpdate,
									Ze = $e.uvsNeedUpdate,
									Je = $e.normalsNeedUpdate,
									et = $e.tangentsNeedUpdate,
									tt = $e.colorsNeedUpdate,
									it = $e.morphTargetsNeedUpdate,
									rt = $e.vertices,
									nt = H.faces3,
									ot = $e.faces,
									at = $e.faceVertexUvs[0],
									st = $e.faceVertexUvs[1],
									lt = $e.skinIndices,
									ht = $e.skinWeights,
									ct = $e.morphTargets,
									ut = $e.morphNormals;
								...
								if (it)
									for (fe = 0, me = ct.length; me > fe; fe++) {
								...
								if (Je && C) {
									for (P = 0, F = nt.length; F > P; P++)
										if (N = ot[nt[P]], U = N.vertexNormals, z = N.normal, 3 === U.length && D)
											for (he = 0; 3 > he; he++) ue = U[he], Oe[Me] = ue.x, Oe[Me + 1] = ue.y, Oe[Me + 2] = ue.z, Me += 3;
										else
											for (he = 0; 3 > he; he++) Oe[Me] = z.x, Oe[Me + 1] = z.y, Oe[Me + 2] = z.z, Me += 3;
									W.bindBuffer(W.ARRAY_BUFFER, H.__webglNormalBuffer), W.bufferData(W.ARRAY_BUFFER, Oe, _)
								}
								if (Ze && at && L) {
									for (P = 0, F = nt.length; F > P; P++)
										if (k = nt[P], I = at[k], void 0 !== I)
											for (he = 0; 3 > he; he++) pe = I[he], Ue[Re] = pe.x, Ue[Re + 1] = pe.y, Re += 2;
									Re > 0 && (W.bindBuffer(W.ARRAY_BUFFER, H.__webglUVBuffer), W.bufferData(W.ARRAY_BUFFER, Ue, _))
								}
								if (Ze && st && L) {
									for (P = 0, F = nt.length; F > P; P++)
										if (k = nt[P], j = st[k], void 0 !== j)
											for (he = 0; 3 > he; he++) de = j[he], ze[be] = de.x, ze[be + 1] = de.y, be += 2;
								...
								if (Xe)
									for (he = 0, ce = Xe.length; ce > he; he++)
										if (qe = Xe[he], qe.__original.needsUpdate) {
											if (Fe = 0, 1 === qe.size) {
												if (void 0 === qe.boundTo || "vertices" === qe.boundTo)
													for (P = 0, F = nt.length; F > P; P++) N = ot[nt[P]], qe.array[Fe] = qe.value[N.a], qe.array[Fe + 1] = qe.value[N.b], qe.array[Fe + 2] = qe.value[N.c], Fe += 3;
												else if ("faces" === qe.boundTo)
													for (P = 0, F = nt.length; F > P; P++) ke = qe.value[nt[P]], qe.array[Fe] = ke, qe.array[Fe + 1] = ke, qe.array[Fe + 2] = ke, Fe += 3
											} else if (2 === qe.size) {
												if (void 0 === qe.boundTo || "vertices" === qe.boundTo)
													for (P = 0, F = nt.length; F > P; P++) N = ot[nt[P]], G = qe.value[N.a], X = qe.value[N.b], q = qe.value[N.c], qe.array[Fe] = G.x, qe.array[Fe + 1] = G.y, qe.array[Fe + 2] = X.x, qe.array[Fe + 3] = X.y, qe.array[Fe + 4] = q.x, qe.array[Fe + 5] = q.y, Fe += 6;
												else if ("faces" === qe.boundTo)
													for (P = 0, F = nt.length; F > P; P++) q = X = G = ke = qe.value[nt[P]], qe.array[Fe] = G.x, qe.array[Fe + 1] = G.y, qe.array[Fe + 2] = X.x, qe.array[Fe + 3] = X.y, qe.array[Fe + 4] = q.x, qe.array[Fe + 5] = q.y, Fe += 6
											} else if (3 === qe.size) {
												var pt;
												if (pt = "c" === qe.type ? ["r", "g", "b"] : ["x", "y", "z"], void 0 === qe.boundTo || "vertices" === qe.boundTo)
													for (P = 0, F = nt.length; F > P; P++) N = ot[nt[P]], G = qe.value[N.a], X = qe.value[N.b], q = qe.value[N.c], qe.array[Fe] = G[pt[0]], qe.array[Fe + 1] = G[pt[1]], qe.array[Fe + 2] = G[pt[2]], qe.array[Fe + 3] = X[pt[0]], qe.array[Fe + 4] = X[pt[1]], qe.array[Fe + 5] = X[pt[2]], qe.array[Fe + 6] = q[pt[0]], qe.array[Fe + 7] = q[pt[1]], qe.array[Fe + 8] = q[pt[2]], Fe += 9;
												else if ("faces" === qe.boundTo)
													for (P = 0, F = nt.length; F > P; P++) q = X = G = ke = qe.value[nt[P]], qe.array[Fe] = G[pt[0]], qe.array[Fe + 1] = G[pt[1]], qe.array[Fe + 2] = G[pt[2]], qe.array[Fe + 3] = X[pt[0]], qe.array[Fe + 4] = X[pt[1]], qe.array[Fe + 5] = X[pt[2]], qe.array[Fe + 6] = q[pt[0]], qe.array[Fe + 7] = q[pt[1]], qe.array[Fe + 8] = q[pt[2]], Fe += 9;
												else if ("faceVertices" === qe.boundTo)
													for (P = 0, F = nt.length; F > P; P++) ke = qe.value[nt[P]], G = ke[0], X = ke[1], q = ke[2], qe.array[Fe] = G[pt[0]], qe.array[Fe + 1] = G[pt[1]], qe.array[Fe + 2] = G[pt[2]], qe.array[Fe + 3] = X[pt[0]], qe.array[Fe + 4] = X[pt[1]], qe.array[Fe + 5] = X[pt[2]], qe.array[Fe + 6] = q[pt[0]], qe.array[Fe + 7] = q[pt[1]], qe.array[Fe + 8] = q[pt[2]], Fe += 9
											} else if (4 === qe.size)
												if (void 0 === qe.boundTo || "vertices" === qe.boundTo)
													for (P = 0, F = nt.length; F > P; P++) N = ot[nt[P]], G = qe.value[N.a], X = qe.value[N.b], q = qe.value[N.c], qe.array[Fe] = G.x, qe.array[Fe + 1] = G.y, qe.array[Fe + 2] = G.z, qe.array[Fe + 3] = G.w, qe.array[Fe + 4] = X.x, qe.array[Fe + 5] = X.y, qe.array[Fe + 6] = X.z, qe.array[Fe + 7] = X.w, qe.array[Fe + 8] = q.x, qe.array[Fe + 9] = q.y, qe.array[Fe + 10] = q.z, qe.array[Fe + 11] = q.w, Fe += 12;
												else if ("faces" === qe.boundTo)
												for (P = 0, F = nt.length; F > P; P++) q = X = G = ke = qe.value[nt[P]], qe.array[Fe] = G.x, qe.array[Fe + 1] = G.y, qe.array[Fe + 2] = G.z, qe.array[Fe + 3] = G.w, qe.array[Fe + 4] = X.x, qe.array[Fe + 5] = X.y, qe.array[Fe + 6] = X.z, qe.array[Fe + 7] = X.w, qe.array[Fe + 8] = q.x, qe.array[Fe + 9] = q.y, qe.array[Fe + 10] = q.z, qe.array[Fe + 11] = q.w, Fe += 12;
											else if ("faceVertices" === qe.boundTo)
												for (P = 0, F = nt.length; F > P; P++) ke = qe.value[nt[P]], G = ke[0], X = ke[1], q = ke[2], qe.array[Fe] = G.x, qe.array[Fe + 1] = G.y, qe.array[Fe + 2] = G.z, qe.array[Fe + 3] = G.w, qe.array[Fe + 4] = X.x, qe.array[Fe + 5] = X.y, qe.array[Fe + 6] = X.z, qe.array[Fe + 7] = X.w, qe.array[Fe + 8] = q.x, qe.array[Fe + 9] = q.y, qe.array[Fe + 10] = q.z, qe.array[Fe + 11] = q.w, Fe += 12;
					...
					if (d = r(l, h), p = d.attributes && g(d), h.verticesNeedUpdate || h.colorsNeedUpdate || h.lineDistancesNeedUpdate || p) {
						var dt = h,
							...
							St = dt.__vertexArray,
							Mt = dt.__colorArray,
							Ct = dt.__lineDistanceArray,
							At = dt.colorsNeedUpdate,
							Lt = dt.lineDistancesNeedUpdate,
							Dt = dt.__webglCustomAttributesList,
							Pt = void 0,
							Ft = void 0,
							kt = void 0,
							Nt = void 0,
						...
						if (Dt)
							for (Pt = 0, Ft = Dt.length; Ft > Pt; Pt++)
								if (zt = Dt[Pt], zt.needsUpdate && (void 0 === zt.boundTo || "vertices" === zt.boundTo)) {
									if (yt = 0, Nt = zt.value.length, 1 === zt.size)
										for (kt = 0; Nt > kt; kt++) zt.array[kt] = zt.value[kt];
									else if (2 === zt.size)
										for (kt = 0; Nt > kt; kt++) Ut = zt.value[kt], zt.array[yt] = Ut.x, zt.array[yt + 1] = Ut.y, yt += 2;
									else if (3 === zt.size)
										if ("c" === zt.type)
											for (kt = 0; Nt > kt; kt++) Ut = zt.value[kt], zt.array[yt] = Ut.r, zt.array[yt + 1] = Ut.g, zt.array[yt + 2] = Ut.b, yt += 3;
										else
											for (kt = 0; Nt > kt; kt++) Ut = zt.value[kt], zt.array[yt] = Ut.x, zt.array[yt + 1] = Ut.y, zt.array[yt + 2] = Ut.z, yt += 3;
									else if (4 === zt.size)
										for (kt = 0; Nt > kt; kt++) Ut = zt.value[kt], zt.array[yt] = Ut.x, zt.array[yt + 1] = Ut.y, zt.array[yt + 2] = Ut.z, zt.array[yt + 3] = Ut.w, yt += 4;
					...
					if (d = r(l, h), p = d.attributes && g(d), h.verticesNeedUpdate || h.colorsNeedUpdate || l.sortParticles || p) {
						var Ot = h,
							...
							Jt = Ot.__colorArray,
							ei = Ot.__sortArray,
							ti = Ot.verticesNeedUpdate,
							ii = Ot.colorsNeedUpdate,
							ri = Ot.__webglCustomAttributesList,
							ni = void 0,
							oi = void 0,
							ai = void 0,
							si = void 0,
						...
						if (Vt.sortParticles) {
							...
							if (ri)
								for (ni = 0, oi = ri.length; oi > ni; ni++)
									if (hi = ri[ni], void 0 === hi.boundTo || "vertices" === hi.boundTo)
										if (Gt = 0, si = hi.value.length, 1 === hi.size)
											for (ai = 0; si > ai; ai++) Xt = ei[ai][1], hi.array[ai] = hi.value[Xt];
										else if (2 === hi.size)
								for (ai = 0; si > ai; ai++) Xt = ei[ai][1], li = hi.value[Xt], hi.array[Gt] = li.x, hi.array[Gt + 1] = li.y, Gt += 2;
							else if (3 === hi.size)
								if ("c" === hi.type)
									for (ai = 0; si > ai; ai++) Xt = ei[ai][1], li = hi.value[Xt], hi.array[Gt] = li.r, hi.array[Gt + 1] = li.g, hi.array[Gt + 2] = li.b, Gt += 3;
								else
									for (ai = 0; si > ai; ai++) Xt = ei[ai][1], li = hi.value[Xt], hi.array[Gt] = li.x, hi.array[Gt + 1] = li.y, hi.array[Gt + 2] = li.z, Gt += 3;
							else if (4 === hi.size)
								for (ai = 0; si > ai; ai++) Xt = ei[ai][1], li = hi.value[Xt], hi.array[Gt] = li.x, hi.array[Gt + 1] = li.y, hi.array[Gt + 2] = li.z, hi.array[Gt + 3] = li.w, Gt += 4
						} else {
							if (ti)
								for (It = 0; Kt > It; It++) Wt = Yt[It], Gt = 3 * It, Zt[Gt] = Wt.x, Zt[Gt + 1] = Wt.y, Zt[Gt + 2] = Wt.z;
							if (ii)
								for (jt = 0; Qt > jt; jt++) qt = $t[jt], Gt = 3 * jt, Jt[Gt] = qt.r, Jt[Gt + 1] = qt.g, Jt[Gt + 2] = qt.b;
							if (ri)
								for (ni = 0, oi = ri.length; oi > ni; ni++)
									if (hi = ri[ni], hi.needsUpdate && (void 0 === hi.boundTo || "vertices" === hi.boundTo))
										if (si = hi.value.length, Gt = 0, 1 === hi.size)
											for (ai = 0; si > ai; ai++) hi.array[ai] = hi.value[ai];
										else if (2 === hi.size)
								for (ai = 0; si > ai; ai++) li = hi.value[ai], hi.array[Gt] = li.x, hi.array[Gt + 1] = li.y, Gt += 2;
							else if (3 === hi.size)
								if ("c" === hi.type)
									for (ai = 0; si > ai; ai++) li = hi.value[ai], hi.array[Gt] = li.r, hi.array[Gt + 1] = li.g, hi.array[Gt + 2] = li.b, Gt += 3;
								else
									for (ai = 0; si > ai; ai++) li = hi.value[ai], hi.array[Gt] = li.x, hi.array[Gt + 1] = li.y, hi.array[Gt + 2] = li.z, Gt += 3;
							else if (4 === hi.size)
								for (ai = 0; si > ai; ai++) li = hi.value[ai], hi.array[Gt] = li.x, hi.array[Gt + 1] = li.y, hi.array[Gt + 2] = li.z, hi.array[Gt + 3] = li.w, Gt += 4
						}
						if ((ti || Vt.sortParticles) && (W.bindBuffer(W.ARRAY_BUFFER, Ot.__webglVertexBuffer), W.bufferData(W.ARRAY_BUFFER, Zt, Bt)), (ii || Vt.sortParticles) && (W.bindBuffer(W.ARRAY_BUFFER, Ot.__webglColorBuffer), W.bufferData(W.ARRAY_BUFFER, Jt, Bt)), ri)
							for (ni = 0, oi = ri.length; oi > ni; ni++) hi = ri[ni], (hi.needsUpdate || Vt.sortParticles) && (W.bindBuffer(W.ARRAY_BUFFER, hi.buffer), W.bufferData(W.ARRAY_BUFFER, hi.array, Bt))
					}
			...
			u = r.join();
			var E;
			for (h = 0, m = Q.length; m > h; h++)
				if (r = Q[h], r.code === u) {
					E = r, E.usedTimes++;
					break
				}
			if (void 0 === E && (E = new THREE.WebGLProgram(this, u, e, i), Q.push(E), $.info.memory.programs = Q.length), e.program = E, E = e.program.attributes, e.morphTargets)
				for (e.numSupportedMorphTargets = 0, m = "morphTarget", h = 0; h < this.maxMorphTargets; h++) u = m + h, 0 <= E[u] && e.numSupportedMorphTargets++;
			if (e.morphNormals)
				for (e.numSupportedMorphNormals = 0, m = "morphNormal", h = 0; h < this.maxMorphNormals; h++) u = m + h, 0 <= E[u] && e.numSupportedMorphNormals++;
			e.uniformsList = [];
			...
			if (e.needsUpdate) {
				...
				if (e instanceof THREE.DataTexture)
					if (0 < a.length && r) {
						...
						e.generateMipmaps = !1
					} else W.texImage2D(W.TEXTURE_2D, 0, n, i.width, i.height, 0, n, o, i.data);
				else if (e instanceof THREE.CompressedTexture)
					for (s = 0, l = a.length; l > s; s++) i = a[s], e.format !== THREE.RGBAFormat ? W.compressedTexImage2D(W.TEXTURE_2D, s, n, i.width, i.height, 0, i.data) : W.texImage2D(W.TEXTURE_2D, s, n, i.width, i.height, 0, n, o, i.data);
			...
			if (e && !e.__webglFramebuffer) {
				...
				if (t) {
					...
					for (var o = 0; 6 > o; o++) {
						...
						var a = e,
							s = W.TEXTURE_CUBE_MAP_POSITIVE_X + o;
		...
		merge: function(e, t, i) {
			...
			for (t = 0, u = c.length; u > t; t++) {
				var d, l = c[t],
					f = l.vertexNormals,
					m = l.vertexColors,
					p = new THREE.Face3(l.a + o, l.b + o, l.c + o);
		...
		parseDDS: function(e, t) {
			...
			function r(e, t, i, r) {
				...
				for (var n = new Uint8Array(n), o = t = 0, a = 0; r > a; a++)
					for (var s = 0; i > s; s++) {
						var l = e[o];
						o++;
						var h = e[o];
			...
			for (var l = l[1] + 4, a = n.width, s = n.height, h = n.isCubemap ? 6 : 1, u = 0; h > u; u++) {
				for (var p = 0; p < n.mipmapCount; p++) {
					if (c) var d = r(e, l, a, s),
						f = d.length;
					else f = Math.max(4, a) / 4 * Math.max(4, s) / 4 * o, d = new Uint8Array(e, l, f);
					n.mipmaps.push({
						data: d,
						width: a,
						height: s
					}), l += f, a = Math.max(.5 * a, 1), s = Math.max(.5 * s, 1)
				}
				...
				if (g.o)
					for (t = g._cachedOutline || (g._cachedOutline = g.o.split(" ")), l = t.length, e = 0; l > e;) switch (s = t[e++]) {
						...
						case "l":
							...
							break;
						case "q":
							if (s = t[e++] * i + r, h = t[e++] * i, p = t[e++] * i + r, d = t[e++] * i, n.quadraticCurveTo(p, d, s, h), o = E[E.length - 1])
							...
							break;
						case "b":
							if (s = t[e++] * i + r, h = t[e++] * i, p = t[e++] * i + r, d = t[e++] * -i, f = t[e++] * i + r, m = t[e++] * -i, n.bezierCurveTo(s, h, p, d, f, m), o = E[E.length - 1])
								for (c = o.x, u = o.y, o = 1, a = this.divisions; a >= o; o++) v = o / a, THREE.Shape.Utils.b3(v, c, p, f, s), THREE.Shape.Utils.b3(v, u, d, m, h)
					}
				return {
					offset: g.ha * i,
					path: n
	...
	function(e) {
				...
				e: {
					...
					if (1e-10 > (f - p) * (g - d) - (m - d) * (E - p)) u = !1;
						...
						var T = void 0,
							...
							w = m - d;
						for (u = 0; r > u; u++)
							if (v = e[l[u]].x, y = e[l[u]].y, !(v === p && y === d || v === f && y === m || v === E && y === g) && (_ = v - p, S = y - d, M = v - f, C = y - m, v -= E, y -= g, M = T * C - x * M, _ = H * S - w * _, S = R * y - b * v, M >= -1e-10 && S >= -1e-10 && _ >= -1e-10)) {
								u = !1;
								break e
							}
						u = !0
		...
		var u = !THREE.Shape.Utils.isClockWise(a[0].getPoints()),
			u = e ? !u : u;
		c = [], s = [], n = [];
		var p, d = 0;
		for (s[d] = void 0, n[d] = [], i = 0, r = a.length; r > i; i++) h = a[i], p = h.getPoints(), l = THREE.Shape.Utils.isClockWise(p), (l = e ? !l : l) ? (!u && s[d] && d++, s[d] = {
			s: new THREE.Shape,
			p: p
		}, s[d].s.actions = h.actions, s[d].s.curves = h.curves, u && d++, n[d] = []) : n[d].push({
			h: h,
			p: p[0]
		});
		if (1 < s.length) {
			for (i = !1, r = [], e = 0, a = s.length; a > e; e++) c[e] = [];
			for (e = 0, a = s.length; a > e; e++)
				for (h = n[e], l = 0; l < h.length; l++) {
		...
		for (i = 0, r = s.length; r > i; i++)
			for (c = s[i].s, o.push(c), e = n[i], a = 0, h = e.length; h > a; a++) c.holes.push(e[a].h);
		return o
		...
		triangulateShape: function(e, t) {
			...
			o = function(e, t) {
				...
				function o(e, t) {
					...
					for (i = 0; i < E.length; i++)
						if (n = i + 1, n %= E.length, n = r(e, t, E[i], E[n], !0), 0 < n.length) return !0;
					return !1
				}
				...
				function a(e, i) {
					...
					for (n = 0; n < g.length; n++)
						for (o = t[g[n]], a = 0; a < o.length; a++)
							if (s = a + 1, s %= o.length, s = r(e, i, o[a], o[s], !0), 0 < s.length) return !0;
					return !1
				}
				var s, l, h, c, u, p, d, f, m, E = e.concat(),
					g = [],
					v = [],
					y = 0;
				...
				for (var T = 2 * g.length; 0 < g.length;) {
					...
					for (h = 0; h < E.length; h++) {
						for (c = E[h], l = -1, y = 0; y < g.length; y++)
							if (u = g[y], p = c.x + ":" + c.y + ":" + u, void 0 === v[p]) {
								for (s = t[u], d = 0; d < s.length; d++)
									if (u = s[d], i(h, d) && !o(c, u) && !a(c, u)) {
			...
			for (o = 0, a = u.length; a > o; o++)
				for (l = u[o], s = 0; 3 > s; s++) h = l[s].x + ":" + l[s].y, h = c[h], void 0 !== h && (l[s] = h);
			return u.concat()
		},
		...
		return function(r) {
			if (!1 !== this.isPlaying) {
				...
				if (!0 === this.loop && this.currentTime > o) this.currentTime %= o, this.reset();
				else if (!1 === this.loop && this.currentTime > o) return void this.stop();
				this.currentTime = Math.min(this.currentTime, o);
				for (var o = 0, a = this.hierarchy.length; a > o; o++)
					for (var s = this.hierarchy[o], l = s.animationCache, h = 0; 3 > h; h++) {
						n = r[h];
						var c = l.prevKey[n],
							u = l.nextKey[n];
						...
						var p = (this.currentTime - c.time) / (u.time - c.time),
							d = c[n],
							f = u[n];
		...
		for (i = (t - e) / i, a = 0; r > a; a++)
			for (0 !== e ? (u = this.vertices[h[0][a]].clone(), p = this.vertices[h[0][a + 1]].clone()) : (u = this.vertices[h[1][a]].clone(), p = this.vertices[h[1][a + 1]].clone()), u.setY(Math.sqrt(u.x * u.x + u.z * u.z) * i).normalize(), p.setY(Math.sqrt(p.x * p.x + p.z * p.z) * i).normalize(), s = 0; n > s; s++) {
				var d = h[s][a],
					f = h[s + 1][a],
					m = h[s + 1][a + 1],
					E = h[s][a + 1],
		...
		var s, l, h, c, u, p = void 0 !== t.amount ? t.amount : 100,
			d = void 0 !== t.bevelThickness ? t.bevelThickness : 6,
			f = void 0 !== t.bevelSize ? t.bevelSize : d - 2,
		...
		var A = THREE.Shape.Utils.triangulateShape(g, C),
			L = g;
		for (w = 0, _ = C.length; _ > w; w++) H = C[w], g = g.concat(H);
		var D, P, F, k, N, U, z = g.length,
			O = A.length,
			y = [],
			B = 0;
		...
		for (D = 0; m > D; D++) {
			...
			for (w = 0, _ = C.length; _ > w; w++)
				for (H = C[w], V = I[w], B = 0, F = H.length; F > B; B++) N = i(H[B], V[B], P), o(N.x, N.y, -k)
		}
		...
		for (F = 1; v >= F; F++)
			for (B = 0; z > B; B++) N = E ? i(g[B], j[B], P) : g[B], T ? (c.copy(l.normals[F]).multiplyScalar(N.x), h.copy(l.binormals[F]).multiplyScalar(N.y), u.copy(s[F]).add(c).add(h), o(u.x, u.y, u.z)) : o(N.x, N.y, p / v * F);
		for (D = m - 1; D >= 0; D--) {
			for (F = D / m, k = d * (1 - F), P = f * Math.sin(F * Math.PI / 2), B = 0, F = L.length; F > B; B++) N = i(L[B], y[B], P), o(N.x, N.y, p + k);
			for (w = 0, _ = C.length; _ > w; w++)
				for (H = C[w], V = I[w], B = 0, F = H.length; F > B; B++) N = i(H[B], V[B], P), T ? o(N.x, N.y + s[v - 1].y, s[v - 1].x + k) : o(N.x, N.y, p + k)
		}! function() {
			if (E) {
				var e;
		...
		for (var n = 1 / (e.length - 1), o = 1 / t, a = 0, s = t; s >= a; a++)
			for (var l = i + a * o * r, h = Math.cos(l), c = Math.sin(l), l = 0, u = e.length; u > l; l++) {
				var p = e[l],
					d = new THREE.Vector3;
		...
		for (var c = new Float32Array(a * s * 2), u = 0, p = 0, d = 0; s > d; d++)
			for (var f = d * h - o, m = 0; a > m; m++) t[u] = m * l - n, t[u + 1] = -f, e[u + 2] = 1, c[p] = m / i, c[p + 1] = 1 - d / r, u += 3, p += 2;
		for (u = 0, n = new(65535 < t.length ? Uint32Array : Uint16Array)(i * r * 6), d = 0; r > d; d++)
			for (m = 0; i > m; m++) o = m + a * (d + 1), s = m + 1 + a * (d + 1), l = m + 1 + a * d, n[u] = m + a * d, n[u + 1] = o, n[u + 2] = l, n[u + 3] = o, n[u + 4] = s, n[u + 5] = l, u += 6;
		...
		for (t = new THREE.Vector3(0, 0, 1), e = 0; r > e; e++)
			for (n = e * i, a = 0; i >= a; a++) u = a + n, o = u + e, h = u + i + e, c = u + i + 1 + e, this.faces.push(new THREE.Face3(o, h, c, [t.clone(), t.clone(), t.clone()])), this.faceVertexUvs[0].push([s[o].clone(), s[h].clone(), s[c].clone()]), o = u + e, h = u + i + 1 + e, c = u + 1 + e, this.faces.push(new THREE.Face3(o, h, c, [t.clone(), t.clone(), t.clone()])), this.faceVertexUvs[0].push([s[o].clone(), s[h].clone(), s[c].clone()]);
		...
		for (l = 1; i >= l; l++)
			for (h = 1; r >= h; h++) e = (r + 1) * l + h - 1, t = (r + 1) * (l - 1) + h - 1, n = (r + 1) * (l - 1) + h, o = (r + 1) * l + h, c = new THREE.Face3(e, t, o, [s[e].clone(), s[t].clone(), s[o].clone()]), this.faces.push(c), this.faceVertexUvs[0].push([a[e].clone(), a[t].clone(), a[o].clone()]), c = new THREE.Face3(t, n, o, [s[t].clone(), s[n].clone(), s[o].clone()]), this.faces.push(c), this.faceVertexUvs[0].push([a[t].clone(), a[n].clone(), a[o].clone()]);
		this.computeFaceNormals()
		...
		var o, a, s, l, h, c, u, p, d, f = [],
			m = t + 1,
			E = new THREE.Vector3;
		for (u = new THREE.TubeGeometry.FrenetFrames(e, t, n), p = u.normals, d = u.binormals, this.tangents = u.tangents, this.normals = p, this.binormals = d, u = 0; m > u; u++)
			for (f[u] = [], s = u / (m - 1), c = e.getPointAt(s), o = p[u], a = d[u], s = 0; r > s; s++) l = s / r * 2 * Math.PI, h = -i * Math.cos(l), l = i * Math.sin(l), E.copy(c), E.x += h * o.x + l * a.x, E.y += h * o.y + l * a.y, E.z += h * o.z + l * a.z, f[u][s] = this.vertices.push(new THREE.Vector3(E.x, E.y, E.z)) - 1;
		for (u = 0; t > u; u++)
			for (s = 0; r > s; s++) m = n ? (u + 1) % t : u + 1, E = (s + 1) % r, e = f[u][s], i = f[m][s], m = f[m][E], E = f[u][E], p = new THREE.Vector2(u / t, s / r), d = new THREE.Vector2((u + 1) / t, s / r), o = new THREE.Vector2((u + 1) / t, (s + 1) / r), a = new THREE.Vector2(u / t, (s + 1) / r), this.faces.push(new THREE.Face3(e, i, E)), this.faceVertexUvs[0].push([p, d, a]), this.faces.push(new THREE.Face3(i, m, E)), this.faceVertexUvs[0].push([d.clone(), o, a.clone()]);
		this.computeFaceNormals(), this.computeVertexNormals()
		...
		function a(e, t) {
			...
			for (c = 0; i > c; c++)
				for (f = 0; 2 * (i - c) - 1 > f; f++) r = Math.floor(f / 2), 0 == f % 2 ? o(h[c][r + 1], h[c + 1][r], h[c][r]) : o(h[c][r + 1], h[c + 1][r + 1], h[c + 1][r])
		}
		...
		var u, p, d, f;
		for (r = 0; i > r; r++)
			for (n = 0; t > n; n++) e = r * c + n, s = r * c + n + 1, a = (r + 1) * c + n + 1, o = (r + 1) * c + n, u = new THREE.Vector2(n / t, r / i), p = new THREE.Vector2((n + 1) / t, r / i), d = new THREE.Vector2((n + 1) / t, (r + 1) / i), f = new THREE.Vector2(n / t, (r + 1) / i), l.push(new THREE.Face3(e, s, o)), h.push([u, p, f]), l.push(new THREE.Face3(s, a, o)), h.push([p.clone(), d, f.clone()]);
		this.computeFaceNormals(), this.computeVertexNormals()
		...
		THREE.Object3D.call(this), void 0 === r && (r = 16776960), void 0 === i && (i = 1), void 0 === n && (n = .2 * i), void 0 === o && (o = .2 * n), this.position = t, t = new THREE.Geometry, t.vertices.push(new THREE.Vector3(0, 0, 0)), t.vertices.push(new THREE.Vector3(0, 1, 0)), this.line = new THREE.Line(t, new THREE.LineBasicMaterial({
			color: r
		})), this.line.matrixAutoUpdate = !1, this.add(this.line), t = new THREE.CylinderGeometry(0, .5, 1, 5, 1), t.applyMatrix((new THREE.Matrix4).makeTranslation(0, -.5, 0)), this.cone = new THREE.Mesh(t, new THREE.MeshBasicMaterial({
			color: r
		})), this.cone.matrixAutoUpdate = !1, this.add(this.cone), this.setDirection(e), this.setLength(i, n, o)
		...
		return function() {
			function r(r, o, a, s) {
				if (e.set(o, a, s), i.unprojectVector(e, t), r = n.pointMap[r], void 0 !== r)
					for (o = 0, a = r.length; a > o; o++) n.geometry.vertices[r[o]].copy(e)
			}
			var n = this;
		...
		for (var n = 0, o = e.length; o > n; n++)
			for (var a = 0, s = e[n].vertexNormals.length; s > a; a++) i.vertices.push(new THREE.Vector3), i.vertices.push(new THREE.Vector3);
		...
		if (e.geometry instanceof THREE.Geometry) {
			for (var l = e.geometry.vertices, h = e.geometry.faces, c = 0, u = new Uint32Array(6 * h.length), p = 0, d = h.length; d > p; p++)
				for (var f = h[p], m = 0; 3 > m; m++) {
					r[0] = f[a[m]], r[1] = f[a[(m + 1) % 3]], r.sort(o);
					var E = r.toString();
					void 0 === n[E] && (u[2 * c] = r[0], u[2 * c + 1] = r[1], n[E] = !0, c++)
				}
			for (s.addAttribute("position", new THREE.Float32Attribute(2 * c, 3)), r = s.attributes.position.array, p = 0, d = c; d > p; p++)
				for (m = 0; 2 > m; m++) c = l[u[2 * p + m]], a = 6 * p + 3 * m, r[a + 0] = c.x, r[a + 1] = c.y, r[a + 2] = c.z
		} else if (e.geometry instanceof THREE.BufferGeometry && void 0 !== e.geometry.attributes.index) {
			for (var l = e.geometry.attributes.position.array, d = e.geometry.attributes.index.array, h = e.geometry.offsets, c = 0, u = new Uint32Array(2 * d.length), f = 0, g = h.length; g > f; ++f)
				for (var m = h[f].start, E = h[f].count, a = h[f].index, p = m, v = m + E; v > p; p += 3)
					for (m = 0; 3 > m; m++) r[0] = a + d[p + m], r[1] = a + d[p + (m + 1) % 3], r.sort(o), E = r.toString(), void 0 === n[E] && (u[2 * c] = r[0], u[2 * c + 1] = r[1], n[E] = !0, c++);
			for (s.addAttribute("position", new THREE.Float32Attribute(2 * c, 3)), r = s.attributes.position.array, p = 0, d = c; d > p; p++)
				for (m = 0; 2 > m; m++) a = 6 * p + 3 * m, c = 3 * u[2 * p + m], r[a + 0] = l[c], r[a + 1] = l[c + 1], r[a + 2] = l[c + 2]
		} else if (e.geometry instanceof THREE.BufferGeometry)
			for (l = e.geometry.attributes.position.array, c = l.length / 3, u = c / 3, s.addAttribute("position", new THREE.Float32Attribute(2 * c, 3)), r = s.attributes.position.array, p = 0, d = u; d > p; p++)
				for (m = 0; 3 > m; m++) a = 18 * p + 6 * m, u = 9 * p + 3 * m, r[a + 0] = l[u], r[a + 1] = l[u + 1], r[a + 2] = l[u + 2], c = 9 * p + (m + 1) % 3 * 3, r[a + 3] = l[c], r[a + 4] = l[c + 1], r[a + 5] = l[c + 2];
		THREE.Line.call(this, s, new THREE.LineBasicMaterial({
			color: i
		}), THREE.LinePieces), this.matrixAutoUpdate = !1, this.matrixWorld = e.matrixWorld
		...
		this.init = function(a) {
			...
			for (E = 0, e.clearColor(1, 1, 1, 1), e.disable(e.BLEND), e.enable(e.CULL_FACE), e.frontFace(e.CCW), t.shadowMapCullFace === THREE.CullFaceFront ? e.cullFace(e.FRONT) : e.cullFace(e.BACK), t.setDepthTest(!0), d = 0, f = u.__lights.length; f > d; d++)
				if (m = u.__lights[d], m.castShadow)
					if (m instanceof THREE.DirectionalLight && m.shadowCascade)
						for (g = 0; g < m.shadowCascadeCount; g++) {
							var b;
							if (m.shadowCascadeArray[g]) b = m.shadowCascadeArray[g];
							else {
		...
		this.init = function(e) {
			...
			var _ = v.createShader(v.VERTEX_SHADER),
				S = v.createShader(v.FRAGMENT_SHADER);
